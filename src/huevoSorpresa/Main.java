...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        HuevoSorpresaSeguraRamalJavier2122 h_sorpresa;
       
        
        h_sorpresa=new HuevoSorpresaSeguraRamalJavier2122(10,5,"peluche",10);
        opera_PrecioSeguraRamalFcoJavier2122(h_sorpresa);
        
        opera_UnidadesSeguraRamalFcoJavier2122(h_sorpresa);
        
    }

    public static void opera_UnidadesSeguraRamalFcoJavier2122(HuevoSorpresaSeguraRamalJavier2122 h_sorpresa) {
    ...
    public static void opera_PrecioSeguraRamalFcoJavier2122(HuevoSorpresaSeguraRamalJavier2122 h_sorpresa) {
